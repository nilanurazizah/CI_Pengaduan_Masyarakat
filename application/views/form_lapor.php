...
<div class="wrapper">
    ...
    <center>
        <p style="margin-top: -1px; font-size: 30px;">Form Pengaduan</p>
        <p style="font-size: 20px;">Masukkan Data yang anda ingin laporkan</p>
    </center>
    <hr>

    <div>
        <form action="<?php echo site_url('Homepage/simpan_lapor'); ?>" method="POST" enctype="multipart/form-data" >
            <div class="row">
                <div class="col">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                    <textarea name="isi" class="form-control" id="exampleFormControlTextarea1" rows="7"></textarea><br>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="" class="col-sm-2" style="margin-left: 10%; font-size: 20px;">Bukti Foto/Video</label>
                    <div class="col-sm-6" >
                    <input type="file" name="files" accept=".jpg, .jpeg, .png, .gif" class="form-control-file">
                    <font color:"red">*</font>
                    </div>
                </div>
