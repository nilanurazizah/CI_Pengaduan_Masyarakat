      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm justify-content-between mb-4">
            <center><h1 class="h4 mb-0 text-gray-800">Data Aduan</h1></center>
            <br>
            
            <!-- buat export pdf dan excel -->
            <a href="<?php echo site_url('homepage/cetak_pdf_aduan') ?>" class="d-none d-sm-inline-block btn btn-sm btn-danger shadow-sm"><i class="fas fa-file fa-sm text-50"></i> Generate PDF</a>
            
            <a href="<?php echo site_url('homepage/cetak_xls_aduan') ?>" class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm"><i class="fas fa-file fa-sm text-50"></i> Generate Excel</a>
        ...
        <div id="view">
        <?php $this->load->view('pengaduan/view', array('model_pengaduan'=>$model_pengaduan)); // Load file view.php dan kirim data siswanya ?>
                ...
                <div class="modal-body">
                    ...
                    <form>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" id="tgl" name="input_tgl" placeholder="Username">
                        </div>
                        <div class="form-group">
                            <label>Isi Pengaduan</label>
                            <textarea name="input_isi" class="form-control" id="isi" cols="30" rows="10" placeholder="Isi Pengaduan"></textarea>                        
                        </div>
                        <div class="form-group">
                            <label>Bukti Foto</label>
                            <input type="text" class="form-control" id="bukti" name="input_bukti">
                        </div>
                    </form>
                </div>
...
<!-- Logout Modal-->
 ...
 <script src="<?= base_url("assets/vendor/jquery/jquery.min.js") ?>"></script>
  ...
  <script src="<?= base_url("assets/js/custom_pengaduan.js") ?>"></script>
