      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm justify-content-between mb-4">
            ...
            <a href="<?php echo site_url('homepage/cetak_pdf_petugas') ?>" class="d-none d-sm-inline-block btn btn-sm btn-danger shadow-sm"><i class="fas fa-file fa-sm text-50"></i> Generate PDF</a>
            
            <a href="<?php echo site_url('homepage/cetak_xls_petugas') ?>" class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm"><i class="fas fa-file fa-sm text-50"></i> Generate Excel</a>
...
-->
<div id="view">
    <?php $this->load->view('data_petugas/view', array('model'=>$model)); // Load file view.php dan kirim data petugasnya ?>
                ...
                <div class="modal-body">
                    ...
                    <form>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="userr" name="input_user" placeholder="Username">
                        </div>
                        <div class="form-group">
                            <label>Password</label>
                            <input type="password" class="form-control" id="pass" name="input_password" placeholder="Password">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label>Level</label>
                            <select id="level" name="input_level" class="form-control">
