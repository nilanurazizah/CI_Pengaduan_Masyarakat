    ...
    <div class="card-body" style="margin-top: -10px; background-color: #F0F8FF;">
        ...
        <hr>
            <?php 
                ...
                { 
            ?>
                <form action="<?php echo base_url() . 'Homepage/update_user'; ?>" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="iduser" value="<?php echo $u->id_user ?>">
                <br>
        <div class="container">
            <div class="form-group row">
                ...
                <div class="form-group row">
                    <label for="" class="col-sm-2" style="margin-left: 10%; font-size: 20px;">Nama</label>
                        <div class="col-sm-6">
                            <input type="text" name="namaa" value="<?php echo $u->nama_masyarakat ?>" class="form-control" style="margin-top: -5px;">
                        </div>
                </div>
                ...
                <div class="form-group row">
                    <label for="" class="col-sm-2" style="margin-left: 10%; font-size: 20px;">Telepon</label>
                        <div class="col-sm-6">
                            <input type="number" name="telep" value="<?php echo $u->telepon ?>" class="form-control" style="margin-top: -5px;">
                        </div>
                </div>
                ...
                <!-- <div class="form-group row">
                    ...
                    <div class="col-sm-6" >
                    <input type="file" name="fiile" class="form-control-file">
                    </div>
                </div> -->
